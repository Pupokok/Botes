...
async def change_moderator(message: types.Message):
    ...
    await bot.send_message(message.from_user.id, 'Master, what do you want from me?', reply_markup=button_case_admin)
...
urlButton1 = InlineKeyboardButton(text='1 VK', url='https://vk.com')
urlButton2 = InlineKeyboardButton(text='2 Behance', url='https://www.behance.net/galleries')
urlkb.add(urlButton1)
x = [InlineKeyboardButton(text='3 OK', url='https://vk.com/arturito7766'), InlineKeyboardButton(text='4 Ислям', url='https://vk.com/kriskic'),\
     InlineKeyboardButton(text='5 Макс', url='https://vk.com/kaldun228')]
...
async def command_start(message: types.Message):
    ...
    try:
        await bot.send_message(message.from_user.id, 'Vas приветствует компания LOK', reply_markup=kb_client)
    except:
...
async def command_power(message: types.Message):
    await bot.send_message(message.from_user.id, 'Круглосуточно', reply_markup=None)
...
async def command_user(message: types.Message):
    await bot.send_message(message.from_user.id, 'Создание лендинга', reply_markup=None)

#Command Расположение
@dp.message_handler(text=['Расположение'])
async def command_rasp(message: types.Message):
    await bot.send_message(message.from_user.id, '55°47,45 c. ш. 49°6,87 в. д', reply_markup=None)
#Command Menu
...
async def mat(message: types.Message):
    if {i.lower().translate(str.maketrans('', '', string.punctuation)) for i in message.text.split(' ')} \
        ...
        await bot.send_message(message.from_user.id,'No commands')
        await message.delete()
